...
void SetupMatrices()
{
	...
	D3DXVECTOR3 vEyePt(0.0f, 0.0f, -5.0f); //눈의 위치(0.0f, 3.0f, -5.0f)
...
void SetupLights()
{
	...
	light.Position = D3DXVECTOR3(5.0, 20.0, 5.0);
	//광원의 방향 설정
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT)
{
	...
	HWND hWnd = CreateWindow("D3D Light", "D3D Light", WS_OVERLAPPEDWINDOW, 100, 100, 1024, 768,
